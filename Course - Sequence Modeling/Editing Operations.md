...
- Transition: $(\mathbf{x}_i^{|\mathbf{x}|}, \mathbf{y}_0^{j-1}) \to (\mathbf{x}_i^{|\mathbf{x}|}, \mathbf{y}_0^j)$
...
- Transition: $(\mathbf{x}_{i-1}^{|\mathbf{x}|}, \mathbf{y}_0^j) \to (\mathbf{x}_i^{|\mathbf{x}|}, \mathbf{y}_0^j)$
...
- Transition: $(\mathbf{x}_{i-1}^{|\mathbf{x}|}, \mathbf{y}_0^{j-1}) \to (\mathbf{x}_i^{|\mathbf{x}|}, \mathbf{y}_0^j)$
- Cost: $\delta_{ij} = \begin{cases} 0 & \text{if } x_i = y_j \\ 1 & \text{if } x_i \neq y_j \end{cases}$
